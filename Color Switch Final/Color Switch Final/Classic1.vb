Public Class Classic1
    ...
    Private Sub Classic1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Timer3_Tick(sender As Object, e As EventArgs) Handles Timer3.Tick
        ...
        ElseIf lblBall.Bottom >= lblBoarder.Top Then
            goUp = False
        End If
        If lblBall.Bounds.IntersectsWith(lblFinishLine.Bounds) Then
            level1Complete = True
            Me.Hide()
            LevelPassed.Show()
            Timer1.Stop()
    ...
    Private Sub Classic1_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        For i = 0 To 17
            labelDown(i) = False
            labelUp(i) = False
            labelRight(i) = False
